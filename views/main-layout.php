...
?>
<div x-data="{ selectedSection: 'dashboard' }" class="flex w-full">
    ...
    <div class="w-1/4">
        ...
        <div class="w-full">
            ...
            <div class="cursor-pointer p-4 border-brand-primary" @click="selectedSection = 'dashboard'" :class="{ 'active': selectedSection === 'dashboard' }">
                <p class="font-bold text-xl">Dashboard</p>
                <p class="text-brand-secondary">Account Info</p>
            </div>

            <div class="p-4 cursor-pointer border-brand-primary" @click="selectedSection = 'loading-icon'" :class="{ 'active': selectedSection === 'loading-icon' }">
                <p class="font-bold text-xl text-brand-secondary">Loading Icon</p>
                <p class="text-brand-secondary">Change your loading icon</p>
            </div>

            <div class="p-4 cursor-pointer border-brand-primary" @click="selectedSection = 'advanced'" :class="{ 'active': selectedSection === 'advanced' }">
                <p class="font-bold text-xl text-brand-secondary">Advanced</p>
                <p class="text-brand-secondary">Fit your exact needs</p>
            </div>

            <div class="p-4 cursor-pointer border-brand-primary" @click="selectedSection = 'help'" :class="{ 'active': selectedSection === 'help' }">
                <p class="font-bold text-xl text-brand-secondary">Help</p>
