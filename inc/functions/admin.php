...
function wp_swapper_register_settings() {
    ...
    register_setting('wp_swapper_target_elements_group', 'wp_swapper_starting_target_element_index');
    register_setting('wp_swapper_target_elements_group', 'wp_swapper_ending_target_element');
    register_setting('wp_swapper_target_elements_group', 'wp_swapper_ending_target_element_index');
}
